...
export const AUDIT_ACTION_MODULE = {
  ...
  'hr.employee.created': 'hr',
  'hr.employee.updated': 'hr',
  'hr.employee.status_changed': 'hr',
  'hr.employee.department_changed': 'hr',
  'hr.employee.designation_changed': 'hr',
  'hr.employee.manager_changed': 'hr',
  ...
  'hr.employee.document_sharing_changed': 'hr',
  'hr.bank_details.updated': 'hr',
  'hr.organization.department_created': 'hr',
  'hr.organization.designation_created': 'hr',
  'hr.organization.location_created': 'hr',
  'hr.organization.schedule_created': 'hr',
  'hr.organization.department_updated': 'hr',
  'hr.organization.designation_updated': 'hr',
  'hr.organization.location_updated': 'hr',
  'hr.organization.schedule_updated': 'hr',
  'hr.attendance.checked_in': 'hr',
  'hr.attendance.checked_out': 'hr',
  'hr.attendance.recorded': 'hr',
  'hr.attendance.corrected': 'hr',
  'hr.leave.type_created': 'hr',
  'hr.leave.requested': 'hr',
  'hr.leave.approved': 'hr',
  'hr.leave.rejected': 'hr',
  'hr.leave.cancelled': 'hr',
  'hr.leave.balance_adjusted': 'hr',
  'hr.expense.created': 'hr',
  'hr.expense.submitted': 'hr',
  'hr.expense.approved': 'hr',
  'hr.expense.rejected': 'hr',
  'hr.expense.cancelled': 'hr',
  'hr.expense.reimbursed': 'hr',
  'hr.expense.reimbursement_failed': 'hr',
  'hr.compensation.created': 'hr',
  'hr.compensation.changed': 'hr',
  'hr.incentive.created': 'hr',
  'hr.incentive.approved': 'hr',
  'hr.payroll.created': 'hr',
  'hr.payroll.processed': 'hr',
  'hr.payroll.finalized': 'hr',
  'hr.payroll.payment_recorded': 'hr',
  'hr.performance.goal_created': 'hr',
  'hr.performance.review_submitted': 'hr',
  'hr.performance.review_acknowledged': 'hr',
  'hr.performance.review_closed': 'hr',
