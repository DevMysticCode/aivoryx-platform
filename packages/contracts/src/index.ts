...
export type CompleteVisitRequest = components['schemas']['CompleteVisitRequestDto'];
export type QuotationVisit = components['schemas']['QuotationVisitDto'];
export type QuotationPipelineSummary = components['schemas']['QuotationPipelineSummaryDto'];
